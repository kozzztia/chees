        ...
        case FIND_TURN:
            return {
                ...
                chessCellState: {
                    ...
                    ...state.chessCellState.cells.forEach(cell => cell.x === action.turnX + 1 && cell.y === action.turnY ? cell.turn = false : { ...cell }),
                    ...state.chessCellState.cells.forEach(cell => cell.x === action.turnX && cell.y === action.turnY ? cell.turn = true : { ...cell }),
                    ...state.chessCellState.cells.forEach(cell => cell.x === action.turnX - 1 && cell.y === action.turnY ? cell.flag = false : { ...cell }),
                    ...state.chessCellState.cells.forEach(cell => cell.x === action.turnX && cell.y === action.turnY ? cell.flag = true : { ...cell }),
                    ...state.chessCellState.cells.forEach(cell => cell.x === action.turnX && cell.y === action.turnY ? cell.flag = true : { ...cell }),
                },
            };
